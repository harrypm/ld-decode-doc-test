...
Running the NTSC/PAL through the [chroma-decoder](ld-chroma-decoder) can produce an raw YUV or RGB uncompressed stream which you can then do anything with! 
