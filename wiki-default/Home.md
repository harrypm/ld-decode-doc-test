![ld-decode logo](assets/logo/ld-decode%20logo%20512px.png)

Welcome to the ld-decode Wiki.

ld-decode is an open-source effort to provide a "software defined LaserDisc player".  

The project aims to take RAW FM RF Archival captures of LaserDiscs, ideally captured by the [Domesday Duplicator](Domesday-Duplicator) hardware and software (as its desgined for LaserDisc RF in mind), but can also take captures from other RF capture devices that make PCM style samples such as the [CX Cards](https://github.com/oyvindln/vhs-decode/wiki/CX-Cards), [MISRC](https://github.com/Stefan-Olt/MISRC), [Hsdaoh](https://github.com/oyvindln/vhs-decode/wiki/RF-Capture-Hardware#hsdaoh-method) and decode the RF back into usable component parts such as composite video, analogue audio and digital data and audio too.
...
Please see the [Installation guide](Installation) for details of how to download and install ld-decode and the [basic usage guide](Basic-usage-of-ld-decode) for instructions on how to use ld-decode.
